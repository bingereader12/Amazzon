...
<div class="row">
  ...
  <div class="row">
    <div class="col-md-12">
        <div class="md-form">
          <label for="subject" class="">Select Store</label>
            <select id="subject" name="store" class="form-control">
              <?php 
              $select="SELECT * FROM stores where seller_id='$ID'";
              $ro=mysqli_query($conn,$select);
